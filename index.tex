...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# lattice stored in a geo{-}table}
\NormalTok{w }\OperatorTok{=}\NormalTok{ weights.contiguity.Queen.from\_dataframe(geojson\_data)}
\NormalTok{w.transform }\OperatorTok{=} \StringTok{"R"}
